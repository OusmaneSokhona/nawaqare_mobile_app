  ...
  moveToNextScreen() async {
    await Future.delayed(const Duration(seconds: 3), () async {
      await LocalStorageUtils.getLogined()
          ...
          :await LocalStorageUtils.getLoginedDoctor()?Get.offAll(MainScreenDoctor(),binding: AppBinding()):await LocalStorageUtils.getLoginedPharmacy()?Get.offAll(MainScreenPharmacy()):await LocalStorageUtils.getFirstTime()
