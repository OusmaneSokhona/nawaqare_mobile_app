...
import 'package:patient_app/screens/profile_screens/edit_medical_vitals.dart';
import 'package:patient_app/screens/profile_screens/edit_personal_info.dart';
...
class ProfileController extends GetxController {
  ...
  final List<String> bloodList = ["O+", "O-", "A+", "A-", "B+", "B-", "AB+", "AB-"];
  ...
  List<String> dataTypeList=["Medical Record","Health Record","Doctor Record"];
