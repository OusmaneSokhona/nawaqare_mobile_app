...
import '../../../controllers/doctor_controllers/add_appointment_patient_module_controller.dart';
...
class AddAppointmentPatientModule extends StatelessWidget {
  final PatientSummary patient;
  final AddAppointmentPatientModuleController controller = Get.put(
    AddAppointmentPatientModuleController(),
  );

  AddAppointmentPatientModule({super.key, required this.patient});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildReasonField(),
                        20.verticalSpace,
                        _buildConsultationTypeDropdown(),
                        20.verticalSpace,
                        Obx(
                              () => controller.selectedConsultationType.value ==
                              "homevisit"
                              ? _buildAddressField()
                              : const SizedBox(),
                        ),
  ...
  Widget _buildConsultationTypeDropdown() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        Container(
          ...
          child: Obx(
              ...
              value: controller.selectedConsultationType.value.isEmpty
                  ? null
                  : controller.selectedConsultationType.value,
              hint: Text(
              ...
              items: const [
                DropdownMenuItem(
                  value: "remote",
                  child: Text("Remote Consultation"),
                ),
                DropdownMenuItem(
                  value: "inperson",
                  child: Text("In-Person Consultation"),
                ),
                DropdownMenuItem(value: "homevisit", child: Text("Home Visit")),
              ],
              onChanged: (value) {
                if (value != null) {
                  controller.selectedConsultationType.value = value;
                }
              },
            ),
          ),
  ...
  Widget _buildAddressField() {
    return Column(
      ...
      children: [
        ...
        CustomTextField(
          labelText: "Address",
          hintText: "Enter complete address for home visit",
