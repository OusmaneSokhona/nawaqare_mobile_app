...
import 'package:patient_app/screens/pharmacy_screens/pharmacy_bank_account_details_screen.dart';
...
import '../patient_screens/search_screens/add_new_card_screen.dart';
class PharmacyPaymentSettingScreen extends StatelessWidget {
  PharmacyPaymentSettingScreen({super.key});
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      5.verticalSpace,
                      Text("Select a payment method to confirm your Payemnts",style: TextStyle(fontSize: 16.sp,color: AppColors.lightGrey),),
                      10.verticalSpace,
                      Align(
                      ...
                      CustomButton(
                        ...
                        text: "Confirm",
                        onTap: () {
                          Get.to(PharmacyBankAccountDetailsScreen());
                        },
                      ),
                      15.verticalSpace,
                     Row(
                       ...
                       children: [
                         Image.asset("assets/images/lock_icon.png",height: 20.sp,),
                         5.horizontalSpace,
                         Text("Secure payment via SSL",style: TextStyle(fontSize: 16.sp,color:AppColors.lightGrey,decoration: TextDecoration.underline,decorationColor: AppColors.lightGrey),),
                       ],
                     ),
                      30.verticalSpace,
                    ],
